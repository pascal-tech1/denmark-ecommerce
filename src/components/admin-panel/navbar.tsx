    ...
    <>
      <header className="sticky top-0 z-10 w-full bg-background/95 shadow backdrop-blur supports-[backdrop-filter]:bg-background/60 dark:shadow-secondary">
        <div className="mx-4 sm:mx-8 flex justify-around gap-4 h-14 items-center">
          <div className=" bg-yellow-300 font-bold  dark:bg-yellow-400 dark:bg-opacity-15 bg-opacity-20  z-50 ">
            <div className="  tracking-wide moving-text text-sm flex justify-between gap-16 py-1 z-50">
              <a
                href="https://wa.me/+2349095606300"
                target="_blank"
                rel="noopener noreferrer"
                className="tracking-widest text-green-600 flex gap-2 items-center justify-center"
              >
                <svg
              ...
              <a
                ...
                className="flex gap-2 items-center  tracking-widest  justify-center"
              >
                <Mail size={14} />
